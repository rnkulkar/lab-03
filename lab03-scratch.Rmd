...
results: 
  ...
  3rd Quartile: $23,520
  Max: $32,720
  IQR: $23,520 - $16,250 = $7270

The median gift aid given by the university is $20,470, with an inter-quartile range of $7,270. There is one one outlier of $32,720.
...
There is a negative correlation between family income and gift aid. The higher a family's income is, the less gift aid they are likely to recieve.
...
For every $1000 increase in family income, there is a $43 decrease in the
gift aid.
...
10. Recall that when we fit a regression model, we assume for any given value of $x$, the $y$ values follow the Normal distribution with mean $\beta_0 + \beta_1 x$ and variance $\sigma^2$. We will look at two sets of plots to check that this assumption holds.
    ...
    The constant variance assumption is met because the spread of the residuals
    is fairly constant at all levels of family income.
...
The Normality assumption is satisfied because the histogram of residuals appears to be
somewhat normal. 
...
I believe that the independence assumption is satisfied because the gift aid that one
family receives should not inherently affect the aid that another family with a different
income level should receive. 
...
gift_aid = -0.043 * family_income + $24,319
         = -0.043 * $90,000 + $24, 319
         = $20,449
...
It would not be wise to use my model to calculate her predicted aid because her family
income is a relative outlier compared to the other family incomes, so the prediction would have a low likelihood of being accurate.
